...
```sh [Mocha]
Evolve Version: %celestiaNodeMochaEvolveTag%
Celestia Node Version: %celestiaNodeMochaTag%
```

```sh [Mainnet]
Evolve Version: %celestiaNodeMainnetEvolveTag%
Celestia Node Version: %celestiaNodeMainnetTag%
```
